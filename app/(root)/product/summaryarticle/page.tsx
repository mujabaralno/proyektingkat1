...
import { getApiSummaryArticle } from '@/app/api/summaryarticle/api';
...
const SummaryArticlePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await getApiSummaryArticle({
        text: input, 
        lang: 'id' 
      });
...
export default SummaryArticlePage;
